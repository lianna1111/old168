      ...
      <table class="table table-bordered">
        <tbody>
          <tr>
            ...
            <td>{{ item.zhengshuxuhaoA }}</td>
            <th scope="row">证书等级：</th>
            <td>{{ item.zhengshudengjiA }}</td>
          </tr>
          <tr>
            <th scope="row">签发日期：</th>
            <td>{{ item.qianfariqiA }}</td>
            <th scope="row">持证姓名：</th>
            <td>{{ item.chizhengxingmingA }}</td>
          </tr>
          <tr>
            <th scope="row">证书舞种</th>
            <td>{{ item.zhengshuwuzhongA }}</td>
            <th scope="row">证书类型：</th>
            <td>{{ item.zhengshuleixingA }}</td>
          </tr>
        </tbody>
      </table>
    </div>
